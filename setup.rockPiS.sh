...
if [ $# -lt 1 ]; then
  ...
  BR_REPO_PATH=$1
  BR_DEFCONFIG=''
  BR_RK3308_DEFCONFIG=rockpis_defconfig
  ...
  if [ ! -e $CUSTOM_PATH/configs/$BR_RK3308_DEFCONFIG ]; then
  	echo can\'t find the file $CUSTOM_PATH/configs/$BR_RK3308_DEFCONFIG
  ...
  if [ ! -z $BR_DEFCONFIG ]; then
    ...
    echo "###### DON'T EDIT THIS FILE, EDIT $BR_RK3308_DEFCONFIG INSTEAD" > $CUSTOM_PATH/configs/$BR_DEFCONFIG
